...
// modificar - span
var ttl_cantHuellas = document.getElementById("ttl_cantHuellas");
var ttl_cantHuesos = document.getElementById("ttl_cantHuesos");
var ttl_cantPelotas = document.getElementById("ttl_cantPelotas");
var ttl_cantMedallas = document.getElementById("ttl_cantMedallas");
var ttl_cantToallas = document.getElementById("ttl_cantToallas");
var ttl_cantTorre = document.getElementById("ttl_cantTorre");
var ttl_cantFuente = document.getElementById("ttl_cantFuente");
var ttl_cantPaq = document.getElementById("ttl_cantPaq");
...
function calc() {
    ...
    // TOTAL DE HUELLAS
    // inputs
    var cantHuellas = parseFloat(document.getElementById("cantHuellas").value);
    var vlr_cantHuellas = cantHuellas * 20000;
    var vlr_cantHuellas_s = Separador(vlr_cantHuellas);
    ttl_cantHuellas.innerHTML = `$ ${vlr_cantHuellas_s}`;

    // TOTAL DE HUESOS
    var cantHuesos = parseFloat(document.getElementById("cantHuesos").value);
    var vlr_cantHuesos = cantHuesos * 15000;
    var vlr_cantHuesos_s = Separador(vlr_cantHuesos);
    ttl_cantHuesos.innerHTML = `$ ${vlr_cantHuesos_s}`;

    // TOTAL DE PELOTAS
    var cantPelotas = parseFloat(document.getElementById("cantPelotas").value);
    var vlr_cantPelotas = cantPelotas * 10000;
    var vlr_cantPelotas_s = Separador(vlr_cantPelotas);
    ttl_cantPelotas.innerHTML = `$ ${vlr_cantPelotas_s}`;

    // TOTAL DE MEDALLAS
    var cantMedallas = parseFloat(document.getElementById("cantMedallas").value);
    var vlr_cantMedallas = cantMedallas * 15000;
    var vlr_cantMedallas_s = Separador(vlr_cantMedallas);
    ttl_cantMedallas.innerHTML = `$ ${vlr_cantMedallas_s}`;

    // TOTAL DE TOALLAS
    var cantToallas = parseFloat(document.getElementById("cantToallas").value);
    var vlr_cantToallas = cantToallas * 15000;
    var vlr_cantToallas_s = Separador(vlr_cantToallas);
    ttl_cantToallas.innerHTML = `$ ${vlr_cantToallas_s}`;

    // TOTAL DE TORREJUEGOS
    var cantTorre = parseFloat(document.getElementById("cantTorre").value);
    var vlr_cantTorre = cantTorre * 10000;
    var vlr_cantTorre_s = Separador(vlr_cantTorre);
    ttl_cantTorre.innerHTML = `$ ${vlr_cantTorre_s}`;

    // TOTAL DE FUENTEPET
    var cantFuente = parseFloat(document.getElementById("cantFuente").value);
    var vlr_cantFuente = cantFuente * 10000;
    var vlr_cantFuente_s = Separador(vlr_cantFuente);
    ttl_cantFuente.innerHTML = `$ ${vlr_cantFuente_s}`;

    // TOTAL DE PAQDIVERTIDO
    var cantPaq = parseFloat(document.getElementById("cantPaq").value);
    var vlr_cantPaq = cantPaq * 15000;
    var vlr_cantPaq_s = Separador(vlr_cantPaq);
    ttl_cantPaq.innerHTML = `$ ${vlr_cantPaq_s}`;

    // ========================================================================

    // PRODUCIDO TOTAL
    var sum_bol = vlr_cantHuellas + vlr_cantHuesos + vlr_cantPelotas + vlr_cantMedallas + vlr_cantToallas + vlr_cantTorre + vlr_cantFuente + vlr_cantPaq;
